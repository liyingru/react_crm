...
class followView extends Component<followProps> {
  ...
  render() {
    const { followList, addFollowCtrl, followData } = this.props;
    const { TabPane } = Tabs;
      ...
      <div style={{ backgroundColor: 'white' }}>
        <div className={styles.headerViewStyle}>
          ...
          <div className={styles.headerButtomStyle}>
            {followData && followData?.showFollowButton == 1 && <Button type="primary" onClick={addFollowCtrl}><EditOutlined />录跟进</Button>}
          </div>
        </div>
