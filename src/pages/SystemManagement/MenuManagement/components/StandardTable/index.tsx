...
export interface StandardTableColumnProps extends ColumnProps<MenuData> {
  needTotal?: boolean;
  total?: number;
}
...
class StandardTable extends Component<StandardTableProps<MenuData>, StandardTableState> {
  static getDerivedStateFromProps(nextProps: StandardTableProps<MenuData>) {
    // clean state
  ...
  constructor(props: StandardTableProps<MenuData>) {
    super(props);
    const { columns } = props;
  ...
  handleRowSelectChange: TableRowSelection<MenuData>['onChange'] = (
    selectedRowKeys,
    selectedRows: MenuData[],
  ) => {
  ...
  handleTableChange: TableProps<MenuData>['onChange'] = (
    pagination,
    filters,
    sorter,
    ...rest
