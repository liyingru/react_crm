...
interface ConfigState {
  ...
  paymentModeList: ConfigListItem[],
  numberList: ConfigListItem[],
...
class TableList extends Component<TableListProps, TableListState, ConfigState> {
  ...
  componentDidMount() {
    ...
    //拉取搜索用户
    dispatch({
      type: 'moneyMangement/getDistributePeopleConifgInfo',
    });
    dispatch({
      type: 'moneyMangement/getUserPermissionList',
    });
  }
