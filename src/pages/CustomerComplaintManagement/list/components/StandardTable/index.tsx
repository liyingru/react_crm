...
import { CustomerComplaintDetail } from '../../../data';
...
export interface StandardTableProps<T> extends Omit<TableProps<T>, 'columns'> {
  ...
  data: {
    ...
    pagination: StandardTableProps<CustomerComplaintDetail>['pagination'];
  };
  // selectedRows: CustomerComplaintDetail[];
  // onSelectRow: (rows: any) => void;
}

export interface StandardTableColumnProps extends ColumnProps<CustomerComplaintDetail> {
  needTotal?: boolean;
  total?: number;
}
...
class StandardTable extends Component<StandardTableProps<CustomerComplaintDetail>, StandardTableState> {
  ...
  constructor(props: StandardTableProps<CustomerComplaintDetail>) {
    super(props);
    // const { columns } = props;
  ...
  handleTableChange: TableProps<CustomerComplaintDetail>['onChange'] = (
    pagination,
    filters,
    sorter,
    ...rest
