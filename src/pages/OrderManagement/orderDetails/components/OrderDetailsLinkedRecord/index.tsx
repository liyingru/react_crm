...
interface OrderDetailsLinkedRecordProps extends FormComponentProps {
  callInfo: Array<callInfoItem>,
  listenrecorder: boolean,
}

class OrderDetailsLinkedRecord extends Component<OrderDetailsLinkedRecordProps>{

  constructor(props: OrderDetailsLinkedRecordProps) {
    super(props);
  ...
  columns = [
    ...
    {
      title: "联系方式",
      dataIndex: "contact_type_txt",
      key: "contact_type_txt",
    },
    {
      title: "主叫号码",
      dataIndex: "caller",
  ...
  render() {
    ...
    return (
      <div className={styles.container} style={{ maxHeight: 700, overflowY: 'auto' }}>
        <div id="components-table-demo-basic">
          <Table scroll={{ x: 'max-content' }} columns={this.state?.showColumns} dataSource={callInfo} pagination={false} />
        </div>
      </div>
    );
  };
...
export default OrderDetailsLinkedRecord;
