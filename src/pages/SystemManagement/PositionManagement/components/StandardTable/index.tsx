...
export interface StandardTableColumnProps extends ColumnProps<PositionData> {
  needTotal?: boolean;
  total?: number;
}
...
class StandardTable extends Component<StandardTableProps<PositionData>, StandardTableState> {
  static getDerivedStateFromProps(nextProps: StandardTableProps<PositionData>) {
    // clean state
  ...
  constructor(props: StandardTableProps<PositionData>) {
    super(props);
    const { columns } = props;
  ...
  handleRowSelectChange: TableRowSelection<PositionData>['onChange'] = (
    selectedRowKeys,
    selectedRows: PositionData[],
  ) => {
  ...
  handleTableChange: TableProps<PositionData>['onChange'] = (
    pagination,
    filters,
    sorter,
    ...rest
