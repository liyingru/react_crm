...
import { Tabs, Icon, Timeline, Card } from "antd";
import { FormComponentProps } from 'antd/es/form';
import { FollowTime } from '../../data';
...
interface FollowUpInfoProps extends FormComponentProps {
  followList: FollowTime[],
  followData: followDataModel,
  getFollowFounction: Function
}

class FollowUpInfo extends Component<FollowUpInfoProps> {
