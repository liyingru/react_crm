...
class CreateForm extends Component<CreateFormProps>  {
  ...
  render() {
    const { form: { getFieldDecorator, getFieldValue }, taocanPrice } = this.props;
          ...
          >
            <Card bordered={false}>
                ...
                <Col span={8}>
                  <FormItem label="商家名称" >
                    {getFieldDecorator('merchant', {
                      ...
                      <Input disabled autoComplete="off" allowClear style={{ width: '100%', }} />
                    )}
                  </FormItem>
                </Col>
              </Row>
              ...
              <Row gutter={{ md: 6, lg: 24, xl: 48 }}>
                {/* <Col span={8}>
                  <FormItem label="关联套系" >
                    {getFieldDecorator('taocanId', { rules: [{ required: false, message: '请选择婚礼套系', }], })(
                      <Select
                        showSearch
                        style={{ width: '100%' }}
                        placeholder="请选择婚礼套系"
                      ...
                      >
                        {
                          contractConfig.taocanList.map(taocan => (
                            <Option title={taocan.price} value={taocan.id}>{taocan.name}</Option>))
                        }
                      </Select>
                    )}
                  </FormItem>
                ...
                <Col span={8}>
                  <FormItem label="套系金额">
                    {getFieldDecorator('taocanAmount', {
                      rules: [{ required: false, message: '请输入套系金额' }],
                ...
                <Col span={8}>
                  <FormItem label="举办日期" >
                    {getFieldDecorator('weddingDate', {
                      rules: [{ required: false, message: '请选择举办日期' }],
                ...
                <Col span={16}>
                  <FormItem label="酒店地址">
                    {getFieldDecorator('hotelAddress', { rules: [{ required: false }], })(
                      <Input autoComplete="off" allowClear style={{ width: '100%', }} />
                    )}
                  </FormItem>
                </Col>
              </Row>
              ...
              <Row gutter={{ md: 6, lg: 24, xl: 48 }}>
                <Col span={8}>
                  <FormItem label="宴会时间" >
                    {getFieldDecorator('weddingDate', {
                      rules: [{ required: false, message: '请选择宴会时间' }],
                      initialValue: (contractConfig.baseInfo.wedding_date) ? moment(contractConfig.baseInfo.wedding_date, 'YYYY-MM-DD') : '',
                    })(
                      <DatePicker style={{ width: '100%', }} format="YYYY-MM-DD"
                ...
                <Col span={8}>
                  <FormItem label="是否使用折扣" >
                    {getFieldDecorator('isDiscount', { rules: [{ required: false, }], })(
                    ...
                    {getFieldDecorator('discountRemark', { rules: [{ required: false, }], })(
                      <Input autoComplete="off" allowClear style={{ width: '65%', }} placeholder="折扣说明" />)}
                  </FormItem>
                </Col>
              </Row>
