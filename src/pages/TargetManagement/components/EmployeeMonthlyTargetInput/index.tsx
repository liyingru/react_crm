...
import { EmployeeMonthlySalesTarget } from "../../salesTarget/data";
const { Option } = Select;

interface EmployeeMonthlyTargetInputProps extends FormComponentProps {
  companyId: string,
...
const EmployeeMonthlyTargetInput: React.FC<EmployeeMonthlyTargetInputProps> = props => {
...
export default Form.create<EmployeeMonthlyTargetInputProps>()(EmployeeMonthlyTargetInput);
